...
public class RabbitTest {
    private static final String URL = "http://127.0.0.1:57811";
    ...
    public void testClient() {
        ...
        //add FairyAnimals
        FairyAnimal fox = new FairyAnimal("Small FairyAnimal", 5,4);
        FairyAnimal crow = new FairyAnimal("Medium FairyAnimal", 15,30);
        FairyAnimal crow2 = new FairyAnimal("Big FairyAnimal", 30,34);
